//
//  PlaylistEpisodesInteractorInput.swift
//  CleanArch
//
...
protocol PlaylistEpisodesInteractorInput {
    func onFetch(page: UInt, completion: @escaping Handler<PlaylistEpisodesInteractor.BussinessObject>)
}
