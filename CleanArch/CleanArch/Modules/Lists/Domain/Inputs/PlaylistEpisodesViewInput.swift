//
//  PlaylistEpisodesViewInput.swift
//  CleanArch
//
 ...
 * para que solamente se pueda interactuar en dirección de entrada mediante la implementación de este protocolo que hereda de ViewInput.
 */

import Foundation

protocol PlaylistEpisodesViewInput: ViewInput {
    func refresh(_ viewObject: PlaylistEpisodesView.ViewObject)
}
