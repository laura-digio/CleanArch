 ...
 * La idea es diseñar la vista de tal manera (con controles de acceso privados en vars y métodos) para que solamente
 * se pueda interactuar en dirección de entrada mediante la implementación de este protocolo que hereda de ViewInput.
 */

import Foundation

protocol ListViewInput: ViewInput {
    func refresh(_ viewObject: ListView.ViewObject)
}
